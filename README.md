...
- ✔ il javadoc temporaneo è pronto ---> aspetto a pubblicarlo per essere sicura che sia completo, perché se dovete aggiungere metodi/ variabili nuove allora dovrei rifarlo
