...
- commentare un pochetto di più il codice  ---> Sara ✔(ho commentato tutto il codice ho scritto)
- eliminare la ridondanza nelle classi sul livello di accesso di json
- ✔ il javadoc temporaneo è pronto ---> aspetto a pubblicarlo per essere sicura che sia completo, perché se dovete aggiungere metodi/ test/ variabili nuove allora dovrei rifarlo
